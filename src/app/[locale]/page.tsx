  ...
  return (
    <div className={classes.container}>
      ...
      <p className={classes.about}>
        Разработчик с навыками создания веб и мобильных приложений с
        использованием React.js, React-Native, Next.js. Особо ценю создание
        сложных, высокопроизводительных приложений, работу в команде
        профессионалов.
      </p>
